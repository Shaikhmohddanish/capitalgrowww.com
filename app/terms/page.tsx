      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="max-w-4xl mx-auto space-y-8 text-gray-300">
          <section>
            ...
            <p>
              By accessing and using the services provided by capitalgrowww.com ("Company", "we", "us"), you
          ...
          <section>
            ...
            <p className="mb-4">
              capitalgrowww.com provides market research, analysis, and trading recommendations. Our services
