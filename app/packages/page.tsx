          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-gradient-to-b from-slate-800 to-slate-900 border-slate-700 hover:border-teal-400 transition-all duration-300 overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-8">
                  <Button className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-3" onClick={() => (window.location.href = "tel:+918976675160")}>
                    Click Here
                  </Button>
                </div>
              </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="bg-gradient-to-b from-slate-800 to-slate-900 border-slate-700 hover:border-teal-400 transition-all duration-300">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6">
                    <Button className="w-full bg-green-500 hover:bg-green-600 text-white text-sm py-2" onClick={() => (window.location.href = "tel:+918976675160")}>
                      Click Here
                    </Button>
                  </div>
                </CardContent>
